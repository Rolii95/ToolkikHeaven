        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center mb-4">
              <span className="text-2xl font-bold text-blue-400">Aurora</span>
              <span className="text-2xl font-bold text-white ml-1">Commerce</span>
            </div>
            <p className="text-gray-300 mb-4">
              Your trusted e-commerce platform with smart pricing, 
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 text-sm">
              &copy; {new Date().getFullYear()} Aurora Commerce. All rights reserved.
            </p>
